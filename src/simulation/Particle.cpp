...
std::vector<StructProperty> const &Particle::GetProperties()
{
	static std::vector<StructProperty> properties = {
		...
		{ "Protons"  , StructProperty::Integer   , offsetof(Particle, Protons) },
		{ "Neutrons" , StructProperty::Integer   , offsetof(Particle, Neutrons)},
		{ "Electrons" , StructProperty::Integer  , offsetof(Particle, Electrons)},
	};
	return properties;
}
